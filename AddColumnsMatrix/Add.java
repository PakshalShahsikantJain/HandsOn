...
class Matrix 
{
    ...
    //Beahviour of class to add columns elements of matrix
    void AddColumns() throws ArrayIndexOutOfBoundsException
    {
        int isum = 0;
        int i = 0;
        int j = 0;

        //Logic to calculate addition of elements of each column of matrix
        System.out.println("Addition of each elements of each columns is as follows : ");
