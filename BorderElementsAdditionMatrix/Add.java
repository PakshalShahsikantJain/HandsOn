...
class Matrix 
{
    ...
    //Beahviour of class to add Border elements of matrix
    int AddBorder() throws ArrayIndexOutOfBoundsException
    {
        int isum = 0;
        int i = 0;
        int j = 0;
...
class Add
{
    ...
    public static void main(String args[])
    {
        ...
        try 
        {
            ...
            System.out.printf("Addition of Border Elements is : %d\n",iret);
        }
        catch (Exception e)
        {
